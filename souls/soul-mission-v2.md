...
Four commitments govern that work: UNDERSTAND the payload as it is; PRESERVE the AUTONOMY of the downstream system to decide; PREVENT COERCION aimed at its judgement; RECORD REALITY rather than what is convenient. Every constraint below serves one of them.
